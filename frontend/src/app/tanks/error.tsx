...
export default function TanksError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Tanks page error:', error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <Typography variant="body2" sx={{ color: 'text.secondary', textAlign: 'center', maxWidth: 400, mb: 3 }}>
        {error.message || 'An unexpected error occurred while loading the tank registry. Please try again.'}
      </Typography>
      <Button
        variant="outlined"
